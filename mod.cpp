...
overview        = "AFI v0.0.0";         // Overview text, displayed from the extension menu
description     = "It's unclear where this will show"; // Probably in context with action
action          = "https://github.com/ARMAFinland/AFI-Mod";    // Website URL, that can accessed from the expansions menu 
