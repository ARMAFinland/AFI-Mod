...
tooltip         = "Tweaks and compatibilities";
tooltipOwned    = "Tweaks and compatibilities";  // Tool tip displayed when the mouse is left over, in the main menu
overview        = "AFI Tweaks v0.0.0";         // Overview text, displayed from the extension menu
description     = "It's unclear where this will show"; // Probably in context with action
action          = "https://github.com/ARMAFinland/AFI-Tweaks";    // Website URL, that can accessed from the expansions menu 
